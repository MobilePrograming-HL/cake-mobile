...
-keepclassmembers class * extends nix.cake.android.data.model.api.request.BaseRequest { *;}
-keep class com.pos.android.data.model.api.response.BaseResponse**
-keepclassmembers class * extends nix.cake.android.data.model.api.response.BaseResponse { *;}